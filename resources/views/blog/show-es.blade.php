        ...
        <div class="container">
            <div class="blog-single-grid">
                <article class="blog-single-main">
                    ...
                    <a class="blog-back-link" href="{{ route('blog.index.es') }}">← Volver al blog</a>
                    ...
                    <div class="blog-category-row">
                        ...
                        <span>5 minutos</span>
                        <span>Ideal para: Viajes, cultura</span>
                    </div>
                    ...
                    <div class="blog-author-box">
                        <div class="left">
                            <p>Escrito por Tulum Airport Cab</p>
                            <p>Descubre el camino, conecta con la naturaleza.</p>
                        </div>

                        @if($translation)
                            <a class="blog-language-link" href="{{ route('blog.show', ltrim($translation->slug, '/')) }}">
                                View in English
                            </a>
                        @endif
                    </div>
                ...
                <aside class="blog-single-sidebar">
                    <h2 class="blog-sidebar-title">Artículos relacionados</h2>

                    <div class="related-list">
                        @forelse(($relatedPosts ?? collect()) as $related)
                            <a class="related-card" href="{{ route('blog.show.es', ltrim($related->slug, '/')) }}">
                                ...
                                <div class="related-card-body">
                                    <span class="related-card-label">Guía de viaje</span>
                                    <div class="related-card-title">{{ $related->title }}</div>
                                    <div class="related-card-meta">Ideal para: Información, actividades</div>
                                </div>
                            </a>
                        @empty
                            <div class="related-card">
                                <div class="related-card-body">
                                    <div class="related-card-title">Más artículos próximamente</div>
                                </div>
                            </div>
                        @endforelse
                    </div>
