...
@section('content')
    ...
    <section class="blog-index">
        <div class="container">
            ...
            @if($heroPost)
                <div class="blog-intro">
                    ...
                    <div class="blog-intro-image">
                        <a href="{{ route('blog.show', ltrim($heroPost->slug, '/')) }}">
                ...
                @if($mainFeatured)
                    <div class="blog-featured">
                        ...
                        <div class="blog-featured-right">
                            ...
                            <a class="blog-read-more" href="{{ route('blog.show', ltrim($mainFeatured->slug, '/')) }}">
                                Read more
                            </a>
                        </div>
                    </div>
                ...
                @if($secondaryFeatured->count())
                    <div class="blog-featured-grid">
                        @foreach($secondaryFeatured as $post)
                            <a class="blog-card-small" href="{{ route('blog.show', ltrim($post->slug, '/')) }}">
            ...
            @if($gridPosts->count())
                <h2 class="blog-grid-title">More Articles</h2>

                <div class="blog-grid-posts">
                    @foreach($gridPosts as $post)
                        <a class="blog-grid-post" href="{{ route('blog.show', ltrim($post->slug, '/')) }}">
                            @if($post->featured_image)
                                <img src="{{ $post->featured_image }}" alt="{{ $post->title }}">
                            @else
                                <img src="/assets/img/hotels/client.jpg" alt="{{ $post->title }}">
