...
/*!******************************************!*\
  !*** ./resources/js/bookingbox/index.js ***!
  \******************************************/
(function () {
  ...
  var setup = {
    ...
    setServiceType: function setServiceType(serviceType) {
      ...
      var allowedServices = ["OW", "RT"];
      if (allowedServices.includes(serviceType)) {
        this.serviceType = serviceType;
      }
    },
    setPax: function setPax(pax) {
      setup.pax = pax;
    },
    setItem: function setItem(element) {
      var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var finalElement = document.getElementById(element);
      finalElement.innerHTML = '';
      if (element === "aff-input-from-elements") {
        var initInput = document.getElementById('aff-input-from');
      ...
      if (element === "aff-input-to-elements") {
        var _initInput = document.getElementById('aff-input-to');
        _initInput.value = data.name;
        setup.items.to.name = data.name;
        setup.items.to.latitude = data.geo.lat;
        setup.items.to.longitude = data.geo.lng;
      }
    },
    setTime: function setTime(element, time) {
      if (element === "init") {
    ...
    autocomplete: function autocomplete(keyword, element) {
      var _this = this;
      ...
      fetch("/api/autocomplete", {
        ...
        _this.makeItems(data, element);
      })["catch"](function (error) {
        console.error('Error:', error);
      });
    },
    makeItems: function makeItems(data, element) {
      var finalElement = document.getElementById(element);
      finalElement.innerHTML = '';
      data = data.items;
    ...
    loadingMessage: function loadingMessage(item) {
      var loader = document.getElementById(item);
      loader.innerHTML = '';
    ...
    getTranslation: function getTranslation(item) {
    ...
    validate: function validate() {
      ...
      var form_data_type = document.createElement('input');
      ...
      var form_data_currency = document.createElement('input');
      ...
      var form_data_language = document.createElement('input');
      ...
      var form_data_passengers = document.createElement('input');
      ...
      var form_data_from = document.createElement('input');
      ...
      var form_data_from_lat = document.createElement('input');
      ...
      var form_data_from_lng = document.createElement('input');
      ...
      var form_data_from_pickupDate = document.createElement('input');
      ...
      var form_data_to_lng = document.createElement('input');
      ...
      if (this.serviceType === "RT") {
        var form_data_to_pickupDate = document.createElement('input');
      ...
      var form_data_crfs = document.createElement('input');
    ...
    hightlight: function hightlight(element, text) {
    ...
    init: function init() {
      ...
      if (data) {
        ...
        var btnCurrency = document.querySelector(".aff-toggle-currency[data-currency=\"".concat(data.currency, "\"]"));
        if (btnCurrency) {
          btnCurrency.click();
        }
        setup.setServiceType(data.type);
        var btnType = document.querySelector(".aff-toggle-type[data-type=\"".concat(data.type, "\"]"));
        if (btnType) {
          btnType.click();
        }
  ...
  var buttons = document.querySelectorAll('.aff-toggle-currency');
  buttons.forEach(function (button) {
    button.addEventListener('click', function () {
      var dataType = this.getAttribute('data-currency');
  ...
  var serviceTypeButtons = document.querySelectorAll('.aff-toggle-type');
  serviceTypeButtons.forEach(function (button) {
    button.addEventListener('click', function () {
      ...
      serviceTypeButtons.forEach(function (btn) {
        btn.classList.remove('active');
      });
      this.classList.add('active');
    });
  ...
  from_autocomplete.addEventListener('focus', function (e) {
    setup.autocomplete(e.target.value, 'aff-input-from-elements');
  });
  ...
  to_autocomplete.addEventListener('focus', function (e) {
    setup.autocomplete(e.target.value, 'aff-input-to-elements');
  });
